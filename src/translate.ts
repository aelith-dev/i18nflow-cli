...
async function translateWithGemini(prompt: string, client: GoogleGenAI): Promise<string> {
...
async function translateWithGroq(prompt: string, client: OpenAI): Promise<string> {
...
export async function translateJSONTree(sourceObj: Record<string, any>, baseLang: string, targetLang: string): Promise<Record<string, any>> {
...
export function deepDiff(source: Record<string, any>, target: Record<string, any>): Record<string, any> {
